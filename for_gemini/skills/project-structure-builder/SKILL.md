...
description: MVP 계획을 바탕으로 개발 프로젝트의 폴더 및 파일 구조를 제안하고 생성합니다.
---
...
Antigravity는 요구사항 정의서, 기능 분해표, MVP 계획서를 바탕으로 수업 시간 안에 구현 가능한 프로젝트 폴더와 파일 구조를 제안하거나 생성해야 합니다.
...
Antigravity는 프로젝트 구조를 만들기 전에 관련 요구사항과 기존 파일을 먼저 확인해야 합니다.
...
- Antigravity는 실제 `.env` 값을 출력하지 않습니다.
...
Antigravity는 다음 순서로 프로젝트 구조를 생성합니다.
