...
Claude는 요구사항 정의서, 기능 분해표, MVP 계획서를 바탕으로 수업 시간 안에 구현 가능한 프로젝트 폴더와 파일 구조를 제안하거나 생성해야 합니다.
...
Claude는 프로젝트 구조를 만들기 전에 관련 요구사항과 기존 파일을 먼저 확인해야 합니다.
